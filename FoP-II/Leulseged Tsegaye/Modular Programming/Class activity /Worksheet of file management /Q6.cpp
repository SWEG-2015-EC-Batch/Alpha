...
fstream leulseged;
izzat.open("data4.txt",ios::out|ios::app);
if(leulseged.is_open()){
    cout<<"Name\t\tExam1\t\tExam2\t\tHomework\t\tFinal exam\t\t Grade"<<endl;
    leulseged<<"Name\t\tExam1\t\tExam2\t\tHomework\t\tFinal exam\t\t Grade"<<endl;
    for(int i=0;i<size;i++){
    cout<<info[i].name<<"\t\t"<<info[i].exam1<<"\t\t"<<info[i].exam2<<"\t\t"<<info[i].homework<<"\t\t\t"<<info[i].final<<"\t\t\t"<<info[i].grade<<endl;
    leulseged<<info[i].name<<"\t\t"<<info[i].exam1<<"\t\t"<<info[i].exam2<<"\t\t"<<info[i].homework<<"\t\t\t"<<info[i].final<<"\t\t\t"<<info[i].grade<<endl;
    leulseged.close();}
}
}
